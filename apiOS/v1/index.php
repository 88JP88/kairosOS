...
Flight::route('POST /postEmployee/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {    
        ...
        $query= modelPost::postEmployee($postData);  //DATA MODAL
...
Flight::route('GET /getOrdersCalculate/@apiData', function ($apiData) {
    header("Access-Control-Allow-Origin: *");
    // Leer los encabezados
    $headers = getallheaders();
...
//echo $apiData;
echo modelGet::getOrdersCalculate($postData);
...
Flight::route('GET /getEmployees/@apiData', function ($apiData) {
    header("Access-Control-Allow-Origin: *");
    // Leer los encabezados
    $headers = getallheaders();
...
//echo $apiData;
echo modelGet::getEmployees($postData);
...
Flight::route('POST /putEmployee/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {    
        ...
        $query= modelPut::putEmployee($postData);  //DATA MODAL
...
Flight::route('POST /putOrder/@apk/@xapk', function ($apk,$xapk) {
    ...
    if (!empty($apk) && !empty($xapk)) {    
        ...
        $query= modelPut::putOrder($postData);  //DATA MODAL
