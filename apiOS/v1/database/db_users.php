...
if($option==2){
    ...
    $usuariodb = "u767251687_dev_kairoscom"; // reemplazar con el usuario de la base de datos
    $passworddb = "LPe903g&"; // reemplazar con la contraseña de la base de datos
    $dbname = "u767251687_dev_kairoscom"; // reemplazar con el nombre de la base de datos
